...
return new class extends Migration
{
    ...
    {
        Schema::create('crm_advertisements_files', function (Blueprint $table) {
            $table->id('file_id');
            $table->string('file_name', 80)->nullable();
            $table->string('file_type', 80)->nullable();
            $table->integer('file_size')->nullable();
            $table->integer('file_advertisements_id')->nullable();
            ...
            $table->index('file_advertisements_id');
        });
    }
    ...
    {
        Schema::dropIfExists('crm_advertisements_files');
    }
};
