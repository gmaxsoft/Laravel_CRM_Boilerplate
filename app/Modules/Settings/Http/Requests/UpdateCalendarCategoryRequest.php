...
class UpdateCalendarCategoryRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'edit_id' => ['required', 'integer', 'exists:crm_calendar_category,cal_cat_id'],
        ];
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'edit_id.required' => module_trans('Settings', 'validation.edit_id.required'),
            'edit_id.exists' => module_trans('Settings', 'validation.edit_id.exists'),
        ];
    }
}
